            ...
            <div class="card-body">           
              <div class="table-responsive">
                <?php 
                     ...
                     $query = "SELECT * FROM admin WHERE AEmail = '$usr'";
      ...
      <div class="modal-content ">
        ...
        <input type="hidden" name="update_id" id="update_id">
          ...
          <div class="form-group">
            ...
            <input type="password" name="APassword" id="APassword" class="form-control" placeholder="Enter Admin Password">            
          </div>
