   ...
   <div class="modal fade" id="AddbuttonModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
      <div class="modal-content ">
        ...
        <form action="insertstudent.php" method="POST" style="padding:40px ;">
          ...
          <div class="form-group">
            ...
            <input type="text" name ="SEmail" class="form-control" placeholder="Enter Email">
          </div>
          <div class="form-group">
            <label>Student Password</label>
            <input type="password" name="SPassword" class="form-control" placeholder="Enter student pass">            
          </div>
          <div class="form-group">
   ...
   <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" >
    <div class="modal-dialog modal-dialog-scrollable" role="document">
      <div class="modal-content ">
        ...
        <form action="updatestudent.php" method="POST" style="padding:40px ;">
        <input type="hidden" name="update_id" id="update_id">
          ...
          <div class="form-group">
            <label>Student Email</label>
            <input type="text" name="SEmail" id="SEmail" class="form-control" placeholder="Enter Student Email">            
          </div>
          <div class="form-group">
            <label>Password</label>
            <input type="text" name ="SPassword" id="SPassword" class="form-control" placeholder="Enter password">
          </div>
          <div class="form-group">
            <label> Student No </label>
  ...
  <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" >
    <div class="modal-dialog modal-dialog-scrollable" role="document">
      <div class="modal-content ">
        ...
        <form action="deletestudent.php" method="POST" style="padding:40px ;">
