   ...
   <div class="modal fade" id="AddbuttonModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
      <div class="modal-content ">
        ...
        <form action="insertcourse.php" method="POST" style="padding:40px ;">
          ...
          <div class="form-group">
            ...
            <input type="text" name ="Lid" class="form-control" placeholder="Enter ID or name">
          </div>
          <div class="form-group">
            <label>Date</label>
            <input type="text" name="CDate" class="form-control" placeholder="Enter course date">            
          </div>
          <div class="form-group">
            <label> Time </label>
            <input type="text" name ="CTime" class="form-control" placeholder="Enter course time">
          </div>
   ...
   <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" >
    <div class="modal-dialog modal-dialog-scrollable" role="document">
      <div class="modal-content ">
        ...
        <form action="updatecourse.php" method="POST" style="padding:40px ;">
        <input type="hidden" name="update_id" id="update_id">
          <div class="form-group">
            <label>Course Name</label>
            <input type="text" name ="Cname" id="Cname" class="form-control" placeholder="Enter full Course name">
          </div>
          <div class="form-group">
            <label>Lecturer Name</label>
            <input type="text" name="Lid" id="Lid" class="form-control" placeholder="Enter Lecturer Name">            
          </div>
          <div class="form-group">
            <label>Course Date</label>
            <input type="text" name ="CDate" id="CDate" class="form-control" placeholder="Enter date">
          </div>
          <div class="form-group">
            <label>Course Time</label>
            <input type="text" name ="CTime" id="CTime" class="form-control" placeholder="Enter time">
          </div>
  ...
  <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" >
    <div class="modal-dialog modal-dialog-scrollable" role="document">
      <div class="modal-content ">
        ...
        <form action="deletecourse.php" method="POST" style="padding:40px ;">
