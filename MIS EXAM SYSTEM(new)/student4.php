...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="student4.php">
        <div class="sidebar-brand-icon rotate-n-15">
          <i class="fas fa-laugh-wink"></i>
        </div>
        <div class="sidebar-brand-text mx-3">Student <sup>2</sup></div>
      </a>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="student4.php">
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="stables2.php">
          <i class="fas fa-fw fa-table"></i>
          <span>Report</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="courselist2.php">
          <i class="fas fa-fw fa-table"></i>
            ...
            <div class="card-body">           
              <div class="table-responsive">
                <?php 
                     ...
                     $query = "SELECT * FROM grades WHERE SEmail = '$usr'";
